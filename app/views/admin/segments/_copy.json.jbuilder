...
json.extract! segment, :resource_id, :resource_type, :template, :shape, :stretch, :alignment, :justification, :margin_top, :margin_bottom, :padding_vertical, :padding_horizontal, :foreground_color, :background_color, :body, :metadata, :inline_styles
