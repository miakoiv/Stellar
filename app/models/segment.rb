...
class Segment < ActiveRecord::Base
  ...
  %w[inverse jumbotron map_marker grid_lines grid_disable_xs masonry show_more thumbnails lightbox].each do |method|
  ...
  private
    def clear_unwanted_attributes
      self.resource_id = nil if resource_type_changed?
