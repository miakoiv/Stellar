...
class Segment < ActiveRecord::Base
  ...
  store :metadata, accessors: [
    ...
    :thumbnails,      # use thumbnails that link to full size images
  ...
  %w[inverse jumbotron map_marker grid_lines grid_disable_xs masonry show_more thumbnails].each do |method|
