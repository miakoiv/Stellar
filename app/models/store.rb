class Store < ApplicationRecord
  ...
  %w[main_nav_lookup detach_menu masonry fancy_cart cart_promotion favorites category_order inline_iframes admit_guests disable_mail disable_shipment_transfers b2b_sales global_sales].each do |method|
