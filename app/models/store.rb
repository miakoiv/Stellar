...
class Store < ActiveRecord::Base
  ...
  def self.theme_options
    @@themes ||= %w{
      birch boutique cards cottage material premium
    }
  end
  ...
  %w[detach_menu wiselinks masonry inline_iframes admit_guests
      disable_mail disable_shipment_transfers b2b_sales global_sales].each do |method|
