class Store < ApplicationRecord
  ...
  %w[main_nav_lookup detach_menu masonry fancy_cart cart_promotion favorites category_order admit_guests custom_smtp_settings disable_mail disable_shipment_transfers b2b_sales global_sales smtp_enable_starttls_auto].each do |method|
