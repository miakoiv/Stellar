...
class Store < ActiveRecord::Base
  ...
  %w[detach_menu wiselinks masonry fancy_cart favorites inline_iframes
     admit_guests disable_mail disable_shipment_transfers b2b_sales
     global_sales].each do |method|
