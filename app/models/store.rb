class Store < ApplicationRecord
  ...
  store :settings, accessors: [
    ...
    :dynamic_navbar,  # boolean, enable dynamic navbar
  ...
  %w[main_nav_lookup detach_menu masonry fancy_cart dynamic_navbar cart_promotion favorites category_order admit_guests custom_smtp_settings disable_mail disable_shipment_transfers b2b_sales global_sales smtp_enable_starttls_auto].each do |method|
