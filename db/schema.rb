...
ActiveRecord::Schema.define(version: 2019_10_02_132726) do
  ...
  create_table "orders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci", force: :cascade do |t|
    ...
    t.integer "shipping_group_id", null: false
    ...
    t.index ["billing_group_id"], name: "index_orders_on_billing_group_id"
    ...
    t.index ["shipping_group_id"], name: "index_orders_on_shipping_group_id"
  ...
  create_table "product_uploads", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci", force: :cascade do |t|
    t.integer "store_id", null: false
    t.string "attachment_file_name"
    t.string "attachment_content_type"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_id"], name: "index_product_uploads_on_store_id"
  end
  ...
  create_table "segments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci", force: :cascade do |t|
    ...
    t.integer "padding_vertical", default: 0, null: false
  ...
  create_table "video_files", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci", force: :cascade do |t|
