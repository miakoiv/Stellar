...
ActiveRecord::Schema.define(version: 20181207112527) do
  ...
  add_index "pictures", ["pictureable_type", "pictureable_id", "purpose", "priority"], name: "picture_master_index", using: :btree
  ...
  create_table "segments", force: :cascade do |t|
    ...
    t.string   "shape",            limit: 255
    t.string   "alignment",        limit: 255,      default: "align-top",      null: false
    t.string   "justification",    limit: 255,      default: "justify-center", null: false
    ...
    t.string   "foreground_color", limit: 255,      default: "#333",           null: false
    t.string   "background_color", limit: 255,      default: "transparent",    null: false
  ...
  add_index "subscriptions", ["store_id"], name: "index_subscriptions_on_store_id", using: :btree
